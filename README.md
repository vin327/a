...
# Требование – описание того, что система должна делать, какими свойствами обладать и каким ограничениям соответствовать.
...
# Методологии и стандарты работы с требованиями
...
# Системы контроля версий – программное обеспечение для облегчения работы с изменяющейся информацией. Такие системы позволяют:
...
# Подходы к интегрированию модулей
...
# Описание требований: унифицированный язык моделирования (UML)
...
## Диаграммы UML (Unified Modeling Language) — это наглядные схемы, с помощью которых описывают структуру, поведение и взаимодействие различных компонентов в рамках системы или проекта. UML не является языком программирования — это язык визуализации
...
# Стандарты качества программной документаций
...
## Использование UML при проектировании
...
# Модульное программирование (определение)
...
# Определение тестирования и отладки
